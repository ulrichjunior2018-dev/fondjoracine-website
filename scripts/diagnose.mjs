...
const requiredImages = [
  ...
  "front-label.png",
  "bottle-back-label-v2.png",
  "profile-logo.png",
  "mount-cameroon-river-bottle.png",
  "monogram-mf-black.png",
  "wordmark-lockup.png",
  "lifestyle-scalp-ritual.png",
  "origin-buea-harvest.png",
  "lifestyle-diaspora-travel.png",
  "lifestyle-father-child.png",
  "product-macro-pipette.png",
  "lifestyle-barbershop.png",
  "flatlay-formula-tools.png",
  "lifestyle-mother-child.png",
];
...
const requiredSiteImageKeys = [
  ...
  "profileLogo",
  "volcanicBottle",
  "hairTextureLifestyle",
  "mountCameroonRiverBottle",
  "originBueaHarvest",
  "monogramMf",
  "wordmarkLockup",
  "lifestyleScalpRitual",
  "lifestyleDiaspora",
  "lifestyleFatherChild",
  "productMacro",
  "flatlayFormula",
  "lifestyleMotherChild",
];
