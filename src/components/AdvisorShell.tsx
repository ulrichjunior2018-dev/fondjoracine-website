...
export function AdvisorShell({ children }: AdvisorShellProps) {
  ...
  return (
    <main className="min-h-screen bg-[#0B0B0B] text-[#F5EFE3] notranslate" translate="no">
      <header
        className="sticky top-0 z-50 text-[#F5EFE3] max-lg:bg-[linear-gradient(180deg,rgb(11_11_11/.58)_0%,rgb(11_11_11/.28)_55%,transparent_100%)] max-lg:pb-5 max-lg:backdrop-blur-[2px] lg:border-b lg:border-[#B8935A]/14 lg:bg-[#0B0B0B]/88 lg:backdrop-blur-xl"
        key={locale}
      >
