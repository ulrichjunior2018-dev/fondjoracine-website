export const hero = {
  ...
  description:
    "Maison Fondjo pairs clinical scalp science with sensorial botanical rituals for healthier-looking density, shine, and softness.",
...
export const ingredients = [
  ...
  {
    name: "Mint botanical note",
    note: "Refreshes the scalp with a clean botanical finish.",
  },
  {
...
export const transformations = [
  ...
  },
  {
    ...
    caption: "Real customer photography pending.",
  },
] as const;
...
export const trustBadges = [
  ...
  "Cameroon delivery confirmed before payment",
] as const;
